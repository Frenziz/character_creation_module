...
def attack(name, char_class):
    if char_class == 'warrior':
        return (f'{name} нанёс урон противнику {5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{name} нанёс урон противнику {5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{name} нанёс урон противнику {5 + randint(-3, -1)}')
    return (f'{name} не нанёс урон противнику')
...
def defence(name, char_class):
    ...
    return (f'{name} не нанёс блокировал урон')
